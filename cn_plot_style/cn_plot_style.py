...
def plot_params(context='default', figsize=None, unit='in', scale=1.0,
                ...
                right_spine=True, top_spine=True, right_ticks=False,
    ...
    params.update({
        ...
        'font.sans-serif': ['FreeSans', 'Helvetica', 'sans-serif'],
        # 'mathtext.fontset': 'custom',
        'figure.titlesize': 12 * text_scale * context_scale * scale,
        'font.size': 8 * text_scale * context_scale * scale,
        'axes.titlesize': 11 * text_scale * context_scale * scale,
        'axes.labelsize': 8 * text_scale * context_scale * scale,
        'xtick.labelsize': 8 * text_scale * context_scale * scale,
